...
public class AdapterTokoDapur extends ArrayAdapter<Barang> implements View.OnClickListener {
    ...
    FirebaseAuth fbAuth;
    private ClickListenerDapur clickListener;

    public AdapterTokoDapur(List<Barang>listBarang, Context context, ClickListenerDapur listener) {
        super(context, R.layout.item_card_toko_dapur_list, listBarang);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.item_card_toko_dapur_list, null, true);

        //connect vew with variable
        TextView namaBarang = listViewItem.findViewById(R.id.tv_item_dapur_name);
        TextView hargaBarang = listViewItem.findViewById(R.id.tv_item_dapur_price);

        ImageView gambarBarang = listViewItem.findViewById(R.id.img_item_dapur);
        Button buttonAddToCart = listViewItem.findViewById(R.id.add_barang_dapur);
    ...
    public interface ClickListenerDapur {
